...
export class MultiSelectComponent implements ControlValueAccessor {
  @ViewChild('toggler', {static: true}) togglerButton: ElementRef;
  ...
  /**
   * TODO: Learn how this works, because it literally does nothing, and if don't exit, don't work. ._.?
   * [DON'T DELETE THIS.]
   */
  @Input()
  public set selectedItemsValue(value: Array<any>) {}
