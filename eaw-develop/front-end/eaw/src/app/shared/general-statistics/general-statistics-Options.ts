...
var Highcharts = require('highcharts'),
    HighchartsGroupedCategories = require('../../../../node_modules/highcharts-grouped-categories/grouped-categories')(Highcharts);
  ...
  export class CustomBaseChart {
    ...
    public async setBaseOptions() {
      this.graphicOptions = {
        ...
        headerFormat: `<table><tr><th style="text-align:left">{point.key}</th></tr>`,
