...
class EvaluationsConstants {
  ...
  /**
   * Columns displayed by the table for evaluator user
   */
  ...
  /**
   * Columns displayed by the table for promoter user
   */
  public static TABLE_COLUMS_PROMOTER = [
    'name',
    'package',
    'segment',
    'specificationsPromoter',
    'initialDate',
    'endDate',
    'remainingDays',
    'state',
  ...
  public static STR_STATES_PLURAL = {
    es: () => {
      const objectStates = {};
      objectStates[`${CommonConstants.EVALUATIONS_STATES.PENDING}`] = 'Pendientes';
      objectStates[`${CommonConstants.EVALUATIONS_STATES.PROGRESS}`] = 'En Progreso';
      objectStates[`${CommonConstants.EVALUATIONS_STATES.FINISHED}`] = 'Finalizadas';
      return objectStates;
    },
    en: () => {
      const objectStates = {};
      objectStates[`${CommonConstants.EVALUATIONS_STATES.PENDING}`] = 'Pendings';
      objectStates[`${CommonConstants.EVALUATIONS_STATES.PROGRESS}`] = 'In Progress';
      objectStates[`${CommonConstants.EVALUATIONS_STATES.FINISHED}`] = 'Finished';
      return objectStates;
    }
  };
  ...
  public static STR_STATES_SINGULAR = {
    es: () => {
      const objectStates = {};
      objectStates[`${CommonConstants.EVALUATIONS_STATES.PENDING}`] = 'Pendiente';
      objectStates[`${CommonConstants.EVALUATIONS_STATES.PROGRESS}`] = 'En Progreso';
      objectStates[`${CommonConstants.EVALUATIONS_STATES.FINISHED}`] = 'Finalizada';
      return objectStates;
    },
    en: () => {
      const objectStates = {};
